...
class Facebook(object):
    def __init__(self):
        ...
        # self.users = r.count_circles(retention)
        # self.users = r.count_circles(referral_weeks)
        self.vocab = []
    ...
    def create_X(self, fb_users, tftransformed):
        '''
    ...
    def create_y(self, fb_users, tftransformed):
        ...
        '''
        y = self.users[['Priority', 'UserID']].fillna(0)
